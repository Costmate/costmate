...
export default function GoogleOption({ buttonText, bottomText, ctaText }) {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      <button className={cn("w-full flex cursor-pointer hover:bg-gray-100 transition justify-center gap-4 font-semibold items-center border-2 p-2 rounded-xl", accentText, accentBorder)}>
